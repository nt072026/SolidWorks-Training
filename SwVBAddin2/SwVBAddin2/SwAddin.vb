...
<Guid("05e9462e-714c-474f-9154-6ef4964f250c")> _
    <ComVisible(True)> _
    <SwAddin( _
        Description:="SwVBAddin2 description", _
        Title:="SwVBAddin2", _
...
#Region "UI Methods"
    Public Sub AddCommandMgr()
        ...
        cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("SwVBAddin2.ToolbarLarge.bmp", thisAssembly)
        cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("SwVBAddin2.ToolbarSmall.bmp", thisAssembly)
        cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("SwVBAddin2.MainIconLarge.bmp", thisAssembly)
        cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("SwVBAddin2.MainIconSmall.bmp", thisAssembly)

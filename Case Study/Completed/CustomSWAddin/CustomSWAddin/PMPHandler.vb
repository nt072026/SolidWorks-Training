...
Imports SolidWorks.Interop.swpublished
  ...
  Sub OnGroupExpand(ByVal id As Integer, ByVal status As Boolean) _
    Implements PropertyManagerPage2Handler9.OnGroupExpand
    Select Case id
      Case 0
        If status = True Then
          iSwApp.SendMsgToUser2("Group 1 was expanded", _
              swMessageBoxIcon_e.swMbInformation, swMessageBoxBtn_e.swMbOk)
        Else
          iSwApp.SendMsgToUser2("Group 1 was collapsed", _
              swMessageBoxIcon_e.swMbInformation, swMessageBoxBtn_e.swMbOk)
        End If
      Case 1
        If status = True Then
          iSwApp.SendMsgToUser2("Group 2 was expanded", _
              swMessageBoxIcon_e.swMbInformation, swMessageBoxBtn_e.swMbOk)
        Else
          iSwApp.SendMsgToUser2("Group 2 was collapsed", _
              swMessageBoxIcon_e.swMbInformation, swMessageBoxBtn_e.swMbOk)
        End If
    End Select
        End Sub
  ...
  Sub OnOptionCheck(ByVal id As Integer) _
    Implements PropertyManagerPage2Handler9.OnOptionCheck
    Select Case id
      Case 3
        iSwApp.SendMsgToUser2("The first option was clicked", _
                swMessageBoxIcon_e.swMbInformation, swMessageBoxBtn_e.swMbOk)
      Case 4
        iSwApp.SendMsgToUser2("The second option was clicked", _
                swMessageBoxIcon_e.swMbInformation, swMessageBoxBtn_e.swMbOk)
      Case 5
        iSwApp.SendMsgToUser2("The third option was clicked", _
                swMessageBoxIcon_e.swMbInformation, swMessageBoxBtn_e.swMbOk)
    End Select
        End Sub

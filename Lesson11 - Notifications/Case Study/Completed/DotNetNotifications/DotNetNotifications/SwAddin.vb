...
#Region "UI Methods"
    Public Sub AddCommandMgr()
        ...
        cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("DotNetNotifications.ToolbarSmall.bmp", thisAssembly)
        cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("DotNetNotifications.MainIconLarge.bmp", thisAssembly)
        cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("DotNetNotifications.MainIconSmall.bmp", thisAssembly)
